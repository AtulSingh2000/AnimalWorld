...
public class MachineAssetCall : MonoBehaviour
{
    ...
    public void RegisterAsset()
    {
        ...
        if (!string.IsNullOrEmpty(asset_id) && !string.IsNullOrEmpty(asset_name))
        {
            ...
            MessageHandler.Server_RegisterAsset(asset_id, asset_name,MessageHandler.userModel.land_id,"machine");
        }
        else
            SSTools.ShowMessage("Machine Not Selected", SSTools.Position.bottom, SSTools.Time.twoSecond);
    }
    ...
    public void DeRegisterAsset()
    {
        ...
        {
            LoadingPanel.SetActive(true);
            MessageHandler.Server_DeRegisterAsset(asset_id, asset_name,"machine");
        }
        else
            SSTools.ShowMessage("Machine Not Selected", SSTools.Position.bottom, SSTools.Time.twoSecond);
    }
